...
namespace OAuthTryGithub
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.ClientId = "****************"; //https://github.com/settings/developers üzerinden aldığınız ClientID
                options.ClientSecret = "************";//https://github.com/settings/developers üzerinden aldığınız ClientSecret
